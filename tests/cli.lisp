...
(defmacro define-cli-test (name command-line &body body)
  `(define-test ,name :parent cli
     (let (;; NOTE: each of these variables should be unbound at
       ...
       (unwind-protect
            (progn
              (main :test-harness-p T :test-argv ',command-line)
              ,@body)
...
(define-cli-test infer-resource-files-without-root ("")
...
(define-cli-test infer-resource-files-with-root ("-r" ".")
