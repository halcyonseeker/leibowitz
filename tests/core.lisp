...
(define-library-test library-datum-mv-where-new-exists-on-disk-not-db (l oldp newp)
  (add-datum l (make-instance 'datum :id oldp))
  (delete-file oldp)
...
(define-library-test library-datum-mv-where-both-exist (l oldp newp)
  (add-datum l (make-instance 'datum :id oldp))
  (fail (library-datum-mv l oldp newp))
...
(define-library-test library-datum-mv-where-old-not-indexed (l)
...
(define-library-test library-datum-mv-old-is-orphaned-and-not-renamed-on-disk (l p)
  (add-datum l (make-instance 'datum :id p))
  (delete-file p)
  (fail (library-datum-mv l p "no such datum")
      'datum-is-orphaned))
